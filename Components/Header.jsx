    ...
    return (
        <div className='py-5 px-5 md:px-12 lg:px-28'>
            ...
            <div className='text-centered my-8'>
                ...
                <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos dolore atque necessitatibus consequuntur expedita sit nesciunt saepe, corporis ex minus a libero itaque autem assumenda unde, reprehenderit nulla quidem nihil?</p>
